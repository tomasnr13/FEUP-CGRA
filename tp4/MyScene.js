...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.textureSideQuad =  'images/mineSide.png';
        this.textureQuadTop = 'images/mineTop.png';
        this.textureQuadBottom = 'images/mineBottom.png';

        this.cube = new MyUnitCubeQuad(this, this.textureQuadTop, this.textureSideQuad, this.textureSideQuad, this.textureSideQuad, this.textureSideQuad, this.textureQuadBottom);
